...
function CDOTABaseAbility:GetDamageSubType()
	local ability = ABILITIES_LIST[self:GetAbilityName()]
	if ability and ability.AbilityUnitDamageSubType then
		return ability.AbilityUnitDamageSubType
	end
	return false
end
