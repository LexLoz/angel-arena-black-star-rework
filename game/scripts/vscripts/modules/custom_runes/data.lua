...
ARENA_RUNE_BOUNTY = 0
ARENA_RUNE_HASTE = 1
ARENA_RUNE_ILLUSION = 2
ARENA_RUNE_INVISIBILITY = 3
ARENA_RUNE_REGENERATION = 4
ARENA_RUNE_ARCANE = 5
ARENA_RUNE_FLAME = 6
ARENA_RUNE_VIBRATION = 7
ARENA_RUNE_SOUL_STEAL = 8
ARENA_RUNE_SPIKES = 9
ARENA_RUNE_TRIPLEDAMAGE = 10
ARENA_RUNE_ACCELERATION = 11


ARENA_RUNE_FIRST = 1
ARENA_RUNE_LAST = ARENA_RUNE_ACCELERATION
