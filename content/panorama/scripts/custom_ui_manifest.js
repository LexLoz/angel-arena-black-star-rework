...
GameUI.CustomUIConfig().attribute_constants = GameUI.CustomUIConfig().attribute_constants || {};
DynamicSubscribeNTListener('attribute_constants', function(tableName, key, value) {
	GameUI.CustomUIConfig().attribute_constants[key] = value;
});
